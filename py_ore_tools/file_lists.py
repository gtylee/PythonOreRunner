...
class FileList(object):
    ...
    def __init__(self, key_list, file_list, file_type, parsing_function):
        ...
        :param file_list:   A list of files in that list, e.g. ['./A.csv', './B.csv', './C.csv']
    ...
    def _parse(self):
        ...
        file_type to the object, e.g. self.csv['A'] contains the content of './A.csv' parsed via pd.read_csv.
        """
        try:
            setattr(self,
                    self._file_type,
...
class InputFiles(FileList):
    ...
    def __init__(self, ore, portfolio, netting, simulation):
        ...
        :param ore:         Location of ore.xml, e.g. './ore.xml'
        :param portfolio:   Location of portfolio.xml, e.g. './portfolio.xml'
        :param netting:     Location of netting.xml, e.g. './netting.xml'
        :param simulation:  Location of simulation.xml, e.g. './simulation.xml'
        """
