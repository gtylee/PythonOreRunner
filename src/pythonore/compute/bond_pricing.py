...
from pythonore.compute.lgm_ir_options import _convolution_nodes_and_weights, _convolution_rollback
...
def _resolve_curve_column_from_id(todaysmarket_xml: Path, curve_id: str) -> str:
    from pythonore.io import ore_snapshot as ore_snapshot_mod
