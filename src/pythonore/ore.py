...
from pythonore.file_lists import InputFiles, OutputFiles
from pythonore.plotter import OutputPlotter
...
class OreBasic(object):
    ...
    def run(self, ore_exe, delete_output_folder_before_run=False):
        ...
        :param ore_exe: Location of the ore executable, e.g. './build/.../App/ore'
