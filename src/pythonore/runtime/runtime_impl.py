...
from pythonore.runtime.lgm.products.fx import (
    convert_fx_forward_npv_to_reporting_ccy as _convert_fx_forward_npv_to_reporting_ccy,
    fx_carry_for_pair as _fx_carry_for_pair,
    fx_forward_closeout_paths as _fx_forward_closeout_paths,
    fx_vol_for_trade as _fx_vol_for_trade,
    price_fx_forward as _lgm_price_fx_forward,
    price_fx_forward_deterministic as _lgm_price_fx_forward_deterministic,
    spot_from_quotes as _spot_from_quotes,
    today_spot_from_quotes as _today_spot_from_quotes,
)
from pythonore.runtime.lgm.products.capfloor import price_trade_capfloor_paths as _lgm_price_trade_capfloor_paths
from pythonore.runtime.lgm.products.swaption import (
    price_swaption_premium_paths as _lgm_price_swaption_premium_paths,
    price_trade_swaption_paths as _lgm_price_trade_swaption_paths,
)
from pythonore.runtime.lgm.products.simple_rates import (
...
class PythonLgmAdapter:
    ...
    def _price_fx_forward(
        ...
        return _lgm_price_fx_forward(
            self,
            trade,
            inputs,
            n_times,
            n_paths,
            shared_sim=shared_sim,
        )
    ...
    def _price_fx_forward_deterministic(
        ...
        return _lgm_price_fx_forward_deterministic(trade, inputs, n_times, n_paths)
    ...
    def _fx_forward_closeout_paths(
        ...
        return _fx_forward_closeout_paths(trade, npv_paths, times, observation_times, closeout_times)
