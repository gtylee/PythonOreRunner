...
- notes: `['sensitivity fallback: Unsupported by PythonLgmAdapter in native-only mode: CAP_USD_SOFR3M_0001:CapFloor, FLOOR_USD_SOFR3M_0001:CapFloor. These trades are supported only through the ORE SWIG fallback.']`
